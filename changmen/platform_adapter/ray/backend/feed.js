...
const { attachRayMatchBetRefs } = require("./_require.js").reqB("core/shared/bet_ref.js");
const { login, fetchMatchPage, fetchOdds, oddsPayloadFromMatchRaw } = require("./session.js");
const { RayWsClient } = require("./ws.js");
const { syncRayFromSession } = require("./_require.js").reqB("core/esport-api/platform_sync.js");
