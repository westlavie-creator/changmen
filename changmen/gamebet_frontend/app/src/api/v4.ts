...
import { a8PluginPost, hasA8PluginRuntime } from "@/collectors/a8/pluginBridge";
...
async function resolveCreditPlateUserName(): Promise<string> {
  ...
  throw new Error("未配置 A8 信用盘账号，请用 TJ01 登录或编辑 gamebet_backend/shared/a8_constants.js");
}
