...
/** apps/backend 根目录（本文件位于 core/shared/） */
...
export function getAdapterRoot() {
  ...
  throw new Error(
    "platform-adapter not found: expected apps/backend/platform_adapter (packaged) or changmen/packages/platform-adapter (dev)",
  );
}
