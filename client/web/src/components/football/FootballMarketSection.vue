      ...
      >
        ...
        >
          ...
          <FootballOddsCell
            ...
            :venue="v.venue"
            :mid="mid"
            :venue-mid="selAt(v.Selections, 'home')?.MatchID"
            :bet-id="selAt(v.Selections, 'home')?.BetID"
          ...
          <FootballOddsCell
            ...
            :venue="v.venue"
            :mid="mid"
            :venue-mid="selAt(v.Selections, 'draw')?.MatchID"
            :bet-id="selAt(v.Selections, 'draw')?.BetID"
            :market-code="marketAttr(row)"
            :line="row.Line"
            :home="home"
            :away="away"
          ...
          <FootballOddsCell
            ...
            :venue="v.venue"
            :mid="mid"
            :venue-mid="selAt(v.Selections, 'away')?.MatchID"
            :bet-id="selAt(v.Selections, 'away')?.BetID"
            :market-code="marketAttr(row)"
            :line="row.Line"
            :home="home"
            :away="away"
      ...
      >
        ...
        >
          ...
          <FootballOddsCell
            ...
            :venue="v.venue"
            :mid="mid"
            :venue-mid="selAt(v.Selections, 'over')?.MatchID"
            :bet-id="selAt(v.Selections, 'over')?.BetID"
            :market-code="marketAttr(row)"
            :line="row.Line"
            :home="home"
            :away="away"
          ...
          <FootballOddsCell
            ...
            :venue="v.venue"
            :mid="mid"
            :venue-mid="selAt(v.Selections, 'under')?.MatchID"
            :bet-id="selAt(v.Selections, 'under')?.BetID"
            :market-code="marketAttr(row)"
            :line="row.Line"
            :home="home"
            :away="away"
