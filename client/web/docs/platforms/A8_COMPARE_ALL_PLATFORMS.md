...
- **changmen**：`resolvePbCollectAccount` 与 A8 `bv` 一致，**仅** `balance!==undefined` 的 PB 账号；HTTP 走 `client/chrome-extension`（`Zn`）。详见 [`A8_PB_LOGIC_PARITY.md`](./A8_PB_LOGIC_PARITY.md)。
...
见 [`server/backend/core/esport-api/platform_sync.js`](../../../backend/core/esport-api/platform_sync.js)。
...
| 能力 | 路径 |
|------|------|
| 采集注册 | [`client/platform-adapter/registry/adapters.ts`](../../../../client/platform-adapter/registry/adapters.ts) |
| 平台能力 | [`client/platform-adapter/registry/`](../../../../client/platform-adapter/registry/) |
| A8 频道 | [`client/platform-adapter/shared/socket/`](../../../../client/platform-adapter/shared/socket/) |
