...
| 代码 | `client/platform-adapter/ob/*` | `client/platform-adapter/ob/bet.ts` |
...
| 代码 | `client/platform-adapter/im/*` | `client/platform-adapter/im/bet.ts` |
...
| 代码 | `client/platform-adapter/tf/*` | `client/platform-adapter/tf/bet.ts` |
...
| 代码 | `client/platform-adapter/pb/*` | `client/platform-adapter/pb/bet.ts` |
...
| 代码 | `client/platform-adapter/imt/*` | `client/platform-adapter/imt/bet.ts` |
...
| 代码 | `client/platform-adapter/stake/*` | `client/platform-adapter/stake/bet.ts` |
...
| 平台 | 采集 | 下注 | 文档 |
|------|------|------|------|
| OB | `client/platform-adapter/ob/` | `client/platform-adapter/ob/bet.ts` | [OB.md](./platforms/OB.md) |
| IM | `client/platform-adapter/im/` | `client/platform-adapter/im/bet.ts` | [IM.md](./platforms/IM.md) |
| TF | `client/platform-adapter/tf/` | `client/platform-adapter/tf/bet.ts` | [A8_TF_LOGIC_PARITY.md](./platforms/A8_TF_LOGIC_PARITY.md) |
| PB | `client/platform-adapter/pb/` | `client/platform-adapter/pb/bet.ts` | [A8_PB_LOGIC_PARITY.md](./platforms/A8_PB_LOGIC_PARITY.md) |
| RAY | `client/platform-adapter/ray/` | `client/platform-adapter/ray/bet.ts` | [RAY.md](./platforms/RAY.md) |
| IMT | `client/platform-adapter/imt/` | `client/platform-adapter/imt/bet.ts` | [IMT.md](./platforms/IMT.md) |
