...
const PROVIDER_PATH = path.resolve(__dirname, "../../../platform-adapter/ob/frontend/bet.ts");
const MQTT_PATH = path.resolve(__dirname, "../../../platform-adapter/ob/frontend/mqtt.ts");
