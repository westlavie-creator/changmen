...
const FAILOVER_ORDER: IaWsEndpointSource[] = ["official", "changmen", "a8"];
...
function nextFailoverConfig(
  ...
  switch (next) {
    ...
    case "a8":
      return getIaA8WsConfig(gateway);
    default:
      return null;
  }
}
...
/** 官网 → CHANGMEN 转发 → A8（对齐 OB demo↔relay） */
