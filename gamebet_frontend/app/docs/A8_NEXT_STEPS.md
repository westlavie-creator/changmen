...
对照基线：`A8/A8frontendscipts/2.0.1/index.js`（新 `/app/`）；可选双轨 `http://localhost:3456/console/`（`PATCH_CONSOLE=1`，vendor bundle）  
...
```bash
cd changmen/gamebet_frontend/app && npm run test:v4
```
