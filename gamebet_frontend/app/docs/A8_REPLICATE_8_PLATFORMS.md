...
changmen 实现：`app/src/collectors/*`、`app/src/providers/*`、`gamebet_backend/esport-api`。
...
| 各平台 `collectors/*` | **应常驻运行**（HTTP/WS/插件），继续写 `oddsStore`、刷新主列表 |
| `collectors/index.ts` | 不因开关关闭而 `stop` 采集器 |
...
| 代码 | `collectors/ob/*`、`providers/obProvider.ts` |
| 凭证 | `platforms.json` OB；[changmen 扩展] 可 `syncObLogin` |
| 下注 | 粘贴 OB 账号 JSON → `ACCOUNT` |
| **parity 缺口** | — | 模式 P 下浏览器 saveMatch + 顺序灌盘 |
| 验收（模式 P） | `ESPORT_BRIDGE=0`；CollectConfig 开 OB → Network：`API_SaveMatch?OB` + `API_SaveBet?OB` + `game/index`/`view` + MQTT |
| 验收（模式 D） | dev.bat 默认；列表来自 bridge，**非** A8 parity 基线 |
...
| 代码 | `collectors/im/index.ts` → `a8/betsCollect.ts` |
...
| 代码 | `collectors/tf/*`、`providers/tfProvider.ts` |
...
| 代码 | `collectors/pb/*`、`providers/pbProvider.ts`、`pb/lineCache.ts` |
...
| 代码 | `collectors/ray/*`、`providers/rayProvider.ts` |
...
| 代码 | `collectors/imt/*`、`providers/imtProvider.ts` |
...
| 代码 | `collectors/stake/*`、`providers/stakeProvider.ts` |
...
| 代码 | `collectors/ia/*`、`providers/iaProvider.ts` |
...
| 平台 | 采集 | 下注 | 文档 |
|------|------|------|------|
| OB | `collectors/ob/` | `providers/obProvider.ts` | [OB.md](../src/collectors/docs/OB.md) |
| IM | `collectors/im/` | `providers/imProvider.ts` | [IM.md](../src/collectors/docs/IM.md) |
| TF | `collectors/tf/` | `providers/tfProvider.ts` | [A8_TF_LOGIC_PARITY.md](../src/collectors/docs/A8_TF_LOGIC_PARITY.md) |
| PB | `collectors/pb/` | `providers/pbProvider.ts` | [A8_PB_LOGIC_PARITY.md](../src/collectors/docs/A8_PB_LOGIC_PARITY.md) |
| RAY | `collectors/ray/` | `providers/rayProvider.ts` | [RAY.md](../src/collectors/docs/RAY.md) |
| IMT | `collectors/imt/` | `providers/imtProvider.ts` | [IMT.md](../src/collectors/docs/IMT.md) |
| STAKE | `collectors/stake/` | `providers/stakeProvider.ts` | [Stake.md](../src/collectors/docs/Stake.md) |
| IA | `collectors/ia/` | `providers/iaProvider.ts` | [IA.md](../src/collectors/docs/IA.md) |

共享：[A8_COMPARE_ALL_PLATFORMS.md](../src/collectors/docs/A8_COMPARE_ALL_PLATFORMS.md)、`collectors/a8/socketHub.ts`、`collectors/a8/pluginBridge.ts`

---

*IA 默认凭证：2026-05-29 增加 `gamebet_backend/shared/ia_a8_collect.js`。*
