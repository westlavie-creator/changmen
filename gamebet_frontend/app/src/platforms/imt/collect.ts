...
import { resolveCollectSession } from "@/platforms/shared/collectSession";
import type { CollectHttpSession } from "@/platforms/shared/collectSession";
...
async function collectImtPost<T>(
