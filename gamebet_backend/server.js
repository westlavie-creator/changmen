...
const { getHardcodedCredentials } = require("./shared/a8_config.js");
...
const CONSOLE_DIR = path.join(__dirname, "..", "gamebet_frontend", "console");
const APP_DIR = path.join(__dirname, "..", "gamebet_frontend", "app", "dist");
...
const server = http.createServer(async (req, res) => {
  try {
    ...
    if (url === "/api/a8/defaults") {
      ...
      res.end(JSON.stringify({ userName: cred.userName, password: cred.password }));
      return;
    }
