 ...
 *
 * Usage:
 *   node scripts/platforms/ob/collect_odd_type_ids.js
 *   node scripts/platforms/ob/collect_odd_type_ids.js --write   # sync into market_catalog.json
 */
...
const OUT_PATH = path.join(__dirname, "ob_odd_type_ids.json");
