#!/usr/bin/env node
/**
 * 从 OB game/index + CDN pc.json 收集 game_id，合并到 ob_game_ids.json（仅补充 hints，不覆盖已验证名称）
 *
 * Usage: node scripts/platforms/ob/collect_game_ids.js
 */
...
const OUT = path.join(__dirname, "ob_game_ids.json");
