 ...
 * 对齐 changmen 前端 / A8 UMe 语义（每场 unsub→view→sub，stage 间隔 1.5s，处理 3 个 /market/*）。
 *
 * Usage:
 *   node platforms/ob/ob_collect_hybrid.js
 *   node platforms/ob/ob_collect_hybrid.js --duration 90 --max-matches 3
 *   node platforms/ob/ob_collect_hybrid.js --platforms ../../data/esport/platforms.json
 *   node platforms/ob/ob_collect_hybrid.js --mqtt-mode relay --relay-ws ws://127.0.0.1:3456/esport/ws/OB
 *   node platforms/ob/ob_collect_hybrid.js --mqtt-mode native
 *   node platforms/ob/ob_collect_hybrid.js --jsonl ./ob_probe.jsonl
 */
...
const { login, obGet, fetchGetTimer, DEFAULT_LOGIN_URL } = require("./ob_session.js");
