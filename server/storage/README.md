...
| 路径 | 内容 |
|------|------|
| `@changmen/storage/paths.js` | `CHANGMEN_ROOT`、`ESPORT_DATA_DIR` |
...
默认数据目录：`server/backend/storage/`（可由 `ESPORT_DATA_DIR` / `CHANGMEN_STORAGE_DIR` 覆盖）。详见 [docs/DATA_STORAGE.md](../../docs/DATA_STORAGE.md)。
