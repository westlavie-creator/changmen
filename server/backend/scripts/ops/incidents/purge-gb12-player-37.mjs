#!/usr/bin/env node
/**
 * 硬删除 GB12 已废弃 OB 投注账号 player 37（米兰/5，已由 13 接管）。
 * 前置：orders/money_logs 无引用。
 *
 * Usage:
 *   node scripts/purge-gb12-player-37.mjs --dry-run
 *   node scripts/purge-gb12-player-37.mjs
 */
...
const PLAYER_IDS = [37];
const BACKUP_TABLE = "players_purge_backup_gb12_37_20260712";
