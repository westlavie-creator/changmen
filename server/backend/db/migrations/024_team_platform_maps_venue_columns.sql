-- team_platform_maps: platform_id → venue_id, platform_name → venue_name
...
COMMENT ON COLUMN team_platform_maps.venue_id IS '场馆侧队伍 ID（SaveMatch HomeID/AwayID 等）';
COMMENT ON COLUMN team_platform_maps.venue_name IS '场馆侧队名';
