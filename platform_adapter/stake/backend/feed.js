...
const { getCatalogSummary } = require("./_require.js").reqB("core/shared/game_catalog.js");
const { attachAggregatorMatchBetRefs } = require("./_require.js").reqB("core/shared/bet_ref.js");
const { tryLoadSession, fetchAllSports, persistPlatform } = require("./session.js");
const { syncStakeFromSession } = require("./_require.js").reqB("core/esport-api/platform_sync.js");
