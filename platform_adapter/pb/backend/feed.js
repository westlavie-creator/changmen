...
const { describePlatformGame, getActivePlatformGameIds, getCatalogSummary } = require("./_require.js").reqB("core/shared/game_catalog.js");
const { attachPbMatchBetRefs } = require("./_require.js").reqB("core/shared/bet_ref.js");
const { loadSession, tryLoadSession, fetchEuroOdds, fetchBalance, persistPlatform } = require("./session.js");
const { syncPbFromSession } = require("./_require.js").reqB("core/esport-api/platform_sync.js");
